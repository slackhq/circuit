...
val seed_bottomBarRed = Color(0xFFBA1A1A)
val seed_bottomBarRose = Color(0xFFFFD9E3)

val tc_light_bottomBarRoseContainer = Color(0xFF7E5260)
val tc_light_onBottomBarRoseContainer = Color(0xFFFFFFFF)
val tc_light_bottomBarRedContainer = Color(0xFFBA1A1A)
val tc_light_onBottomBarRedContainer = Color(0xFFFFFFFF)

val tc_dark_bottomBarRedContainer = Color(0xFF930009)
val tc_dark_onBottomBarRedContainer = Color(0xFFFFFFFF)
val tc_dark_bottomBarRoseContainer = Color(0xFF7A294B)
val tc_dark_onBottomBarRoseContainer = Color(0xFFFFFFFF)
