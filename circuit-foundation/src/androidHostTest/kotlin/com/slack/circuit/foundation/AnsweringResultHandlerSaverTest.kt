...
class AnsweringResultHandlerSaverTest {
  ...
  fun saverRestoresLegacyExpectationWithoutPendingResult() {
    val restored =
      answeringResultHandlerSaver(PassThroughCircuitSaver)
  ...
  private fun setContent(circuitSaver: CircuitSaver = PassThroughCircuitSaver) {
    stateRestorationTester.setContent {
      handler = rememberAnsweringResultHandler(circuitSaver)
    }
  }
}
