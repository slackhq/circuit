 ...
 */
@Composable
public fun <T : Any> rememberRetained(vararg inputs: Any?, key: Any? = null, init: () -> T): T {
  ...
  val finalKey = key ?: compositeKey.toString(MaxSupportedRadix)
...
private class RetainableHolder<T>(
  ...
  fun update(registry: RetainedStateRegistry?, key: Any, value: T, inputs: Array<out Any?>) {
