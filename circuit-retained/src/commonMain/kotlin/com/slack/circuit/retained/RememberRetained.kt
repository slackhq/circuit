 ...
 * Contexts, Views, etc).
 *
 * By specifying a [saver], you can also serialize the retained value to saved instance state, in
 * addition to keeping it in memory, to persist some state through process death.
 *
